function main() {
    ...
    if (!gl.getShaderParameter(fshader, gl.COMPILE_STATUS)) {
        let str = gl.getShaderInfoLog(fshader);
        console.log(str);
    }
    ...
    if (!gl.getProgramParameter(program, gl.LINK_STATUS)) {
        let str = gl.getProgramInfoLog(program);
        console.log(str);
    }
    ...
    img1.onload = () => {
        count++;
        onImgLoad(gl, gl.TEXTURE1, img1, count);
    }
    img2.onload = () => {
        count++;
        onImgLoad(gl, gl.TEXTURE2, img2, count);
    }
    img1.src = 'sky.jpg';
    img2.src = 'circle.gif';    
}

function onImgLoad(gl, tex_unit_id, img, count) {    
